          ...
          <div className="col-span-2 md:col-span-2 flex flex-col items-start gap-4 sm:gap-6">
            ...
            <div className="flex gap-4">
              <a href="#" aria-label="Instagram" className="text-[#6B7280] hover:text-[#A31D1D] transition-colors cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-instagram w-4.5 h-4.5">
              ...
              <a href="#" aria-label="Twitter" className="text-[#6B7280] hover:text-[#A31D1D] transition-colors cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-twitter w-4.5 h-4.5">
              ...
              <a href="#" aria-label="LinkedIn" className="text-[#6B7280] hover:text-[#A31D1D] transition-colors cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-linkedin w-4.5 h-4.5">
