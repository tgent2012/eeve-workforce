  ...
  return (
    ...
    >
      <div className="w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 items-center gap-10 lg:gap-12 relative z-20">
        ...
        {/* Right Side: Cosmic Orb Visual Asset */}
        <motion.div
        ...
        >
          {/* Subtle Ambient Glowing Backplate */}
          <div className="absolute w-72 h-72 sm:w-96 sm:h-96 rounded-full bg-gradient-to-tr from-[#A31D1D]/20 via-[#FBBF24]/15 to-transparent blur-3xl -z-10 pointer-events-none" />
          ...
          <Orb
            ...
            lens={true}
            lensAmount={50}
            className="w-[280px] h-[280px] sm:w-[360px] sm:h-[360px] lg:w-[420px] lg:h-[420px] drop-shadow-2xl"
          />
        </motion.div>
