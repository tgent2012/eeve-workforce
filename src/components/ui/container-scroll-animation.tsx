...
export const ContainerScroll = ({
  ...
  return (
    <div
      className="w-full relative flex flex-col items-center justify-start p-2 md:p-12"
      ref={containerRef}
    >
      <div
        className="pt-0 pb-12 md:pb-24 w-full relative"
        style={{
...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-7xl -mt-12 mx-auto h-[35rem] md:h-[45rem] w-full border border-neutral-200/50 p-1 sm:p-2 md:p-4 bg-white rounded-[24px] sm:rounded-[30px] shadow-2xl overflow-hidden"
    >
